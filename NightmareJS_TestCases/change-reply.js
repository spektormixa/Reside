...
Nightmare()
    ...
    .evaluate(() => document.querySelector('.listgroup').href)
    
    // Changing of existing reply
    .wait('button[aria-label ="Edit reply"]')
    .click('button[aria-label ="Edit reply"]')
    .insert('#saved-reply-title-field', 'changed')
